    ...
    <header>
      <nav class="nav">
        <div class="logo-container">
          ...
          <img src="/img/menu.png" class="menu-btn" id="menu-btn" />
        </div>
        <ul class="list-items">
          <li class="list">
      ...
      <div class="container">
        <div class="container-left">
          ...
          <div class="input-container">
            <img src="/img/mail.png" class="input-icon" />
          ...
          <img src="/img/wave-left.png" class="wave-left" />
        </div>
        ...
        <div class="container-right">
          ...
          <img
            ...
            src="/img/couples-mobile.png"
            alt=""
          />
          <img src="/img/details.png" class="details-img" />
          <img src="/img/wave-right.png" class="wave-right" />
        </div>
      </div>
    </header>
  </body>
